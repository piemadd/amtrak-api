...
const lineData = JSON.parse(fs.readFileSync('./nationalRoute.json', { encoding: 'utf8', flag: 'r' }))
...
app.get('/nationalRoute.json', (req, res) => {
...
const updateData = (async () => {
  ...
  amtrak.fetchTrainData().then((trainsTemp) => {
    ...
    dataFeedIsStale = timeSinceLastUpdate > 600000;
